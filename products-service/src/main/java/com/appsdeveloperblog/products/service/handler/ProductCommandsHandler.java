...
public class ProductCommandsHandler {
    ...
    private final Logger logger = LoggerFactory.getLogger(ProductCommandsHandler.class.getName());
    ...
    public void handleCommand(@Payload ReserveProductCommand command) {
        ...
        try {
            ...
            ProductReservedEvent productReservedEvent = new ProductReservedEvent(command.getOrderId(), reservedProduct.getId(),
                    reservedProduct.getPrice(), reservedProduct.getQuantity());
